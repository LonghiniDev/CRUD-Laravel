        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['action' =>'GuitarristaController@store', 'method' => 'POST'])!!}
                    ...
                    <div class="form-group">
                        {!! Form::label(__('Banda:')) !!}
                        {!! Form::text("banda", null ,["class"=>"form-control","required"=>"required"]) !!}
                    </div>

                    <div class="form-group">
                        {!! Form::label(__('Idade:')) !!}
                        {!! Form::text("idade", null ,["id" => "idade", "class"=>"form-control mmss","required"=>"required"]) !!}
                    </div>
